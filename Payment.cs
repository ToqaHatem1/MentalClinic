    ...
    public partial class Payment : Form
    {
        ...
        private void Payment_Load(object sender, EventArgs e)
        {
            try
            {
                IDcb.Items.Clear();
                conn.Open();
                String id = "SELECT PatId FROM PatientTbl ORDER BY PatId";
        ...
        {
            IDcb.Text = PaymentList.SelectedRows[0].Cells[1].Value.ToString();
            NameTxt.Text = PaymentList.SelectedRows[0].Cells[2].Value.ToString();
            PaymentTxt.Text = PaymentList.SelectedRows[0].Cells[3].Value.ToString();
